<?php
/*
Plugin Name: FooBox HTML & Media Lightbox (Share on Theme123.Net)
Plugin URI: http://theme123.net/
...
include 'includes/foolic_class.php';
...
if (!class_exists('fooboxV2')) {
	...
	class fooboxV2 extends wp_pluginbase_v2_6_2 {
		...
		function init() {
			...
			$update_checker = new foolic_update_checker_v1_5(__FILE__, self::UPDATE_URL, $this->plugin_slug, get_site_option($this->plugin_slug . '_licensekey'));
			$this->foolic_validator = new foolic_validation_v1_3(self::UPDATE_URL, $this->plugin_slug);
